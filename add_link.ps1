...
$rep=$dam+"n+='"+'<a is="emby-linkbutton" class="navMenuOption lnkMediaFolder" href="http://192.168.1.33:5000/" target="_blank"><i class="md-icon navMenuOptionIcon"><img src="https://raw.githubusercontent.com/Sarin-jacob/files/main/slogo.png"></i><span class="navMenuOptionText"'+">'+"+'m.ZP.translate("Requests & Issues")+"</span></a>",'+"n+='"+'<a is="emby-linkbutton" class="navMenuOption lnkMediaFolder" href="http://192.168.1.33/sam.html" target="_blank"><i class="md-icon navMenuOptionIcon"><img src="https://raw.githubusercontent.com/Sarin-jacob/files/main/donate4.png"></i><span class="navMenuOptionText"'+">'+"+'m.ZP.translate("Buy me chocolate😋")+"</span></a>",'
